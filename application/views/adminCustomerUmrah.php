 ...
 <div class="right_col" role="main">
      <div class="">
          ...
          <div class="row">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>Panel Setup Jamaah Umrah</h2>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                    ...
                    <div class="panel panel-primary">
                          <div class="panel-heading">
                              <i class="fa fa-table"></i> Data Jamaah Umrah
                          </div>
                          <!-- /.panel-heading -->
                                      ...
                                      <td>
                                        <center>
                                          <div class="tooltip-demo">
                                            ...
                                            <a href="<?php echo site_url('adminCustomerUmrah/hapus/'.$row->id_jamaah); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$row->nama;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                          </div>
                                        </center>
                                      </td>
                                    </tr>
                     ...
                     <!-- /.panel-primary -->
                          ...
                          <div id="modal-tambah" class="modal fade">
                              <div class="modal-dialog">
                                <form class="form-horizontal" action="<?php echo site_url('adminCustomerUmrah/add'); ?>" method="post">
                    ...
                    <?php $no=0; foreach($all as $row): $no++; ?>
                                    <div class="row">
                                      <div id="modal-edit<?=$row->id_jamaah;?>" class="modal fade">
                                        <div class="modal-dialog">
                                          <form class="form-horizontal" action="<?php echo site_url('adminCustomerUmrah/edit'); ?>" method="post">
                                          <div class="modal-content">
                                            <div class="modal-header bg-primary">
                                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            ...
                                            <div class="modal-body">
                                                  ...
                                                  <div class="form-group">
                                                      <label class='col-md-3'>Alamat</label>
                                                      <div class='col-md-9'><textarea type="text" name="alamat" autocomplete="off" value="<?=$row->alamat;?>" required placeholder="Masukkan Alamat" class="form-control" ><?php echo $row->alamat;?></textarea></div>
                                                 </div>
                                                  <div class="form-group">
                                                      <label class='col-md-3'>Nomor Telepon</label>
                                                  ...
                                                  <div class="form-group">
                                                      <label class='col-md-3'>Email</label>
                                                      <div class='col-md-9'><input type="email" name="email" autocomplete="off" value="<?=$row->email;?>" placeholder="Masukkan Email" class="form-control" ></div>
                                                 </div>
                                                 <div class="form-group">
                                                      <label class='col-md-3'>Pendidikan</label>
                                                          <div class='col-md-9'>
                                                              <select name="pendidikan"  required class="form-control">
                                                                <option selected disable><?php echo $row->pendidikan;?></option>
                                                                <option >SD/MI</option>
                                                                <option >SMP/MTS/SLTP</option>
                                                                <option >SMA/MAN/SLTA</option>
                                                                <option >S1</option>
                                                  ...
                                                  <div class="form-group">
                                                      <label class='col-md-3'>Pekerjaan</label>
                                                          <div class='col-md-9'>
                                                              <select name="pekerjaan" required class="form-control">
                                                                <option selected disable><?php echo $row->pekerjaan;?></option>
                                                                <option >Pegawai Negeri</option>
                                                                <option >Pegawai Swasta</option>
                                                                <option >Wirausaha</option>
                                                                <option >TNI/POLRI</option>
