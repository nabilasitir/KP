          ...
          <div class="">
             <div class="page-title">
              <div class="title_left">
                <h3>Petunjuk Haji & Umrah</h3>
                <h3><small>Klik untuk menambahkan/mengedit Petunjuk Haji & Umrah</small></h3>
              </div>
            ...
            <div class="row">
              <div>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Panel Setup Petunjuk Haji & Umrah</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                                                    ...
                                                    <td>
                                                      <center>
                                                          <div class="tooltip-demo">
                                                            ...
                                                            <a href="<?php echo site_url('adminDownload/hapus/'.$row->id); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$row->nama_file;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                                          </div>
                                                      </center>
                                                    </td>
                                                </tr>
                     ...
                     <div id="modal-tambah" class="modal fade">
                      <div class="modal-dialog">
                       <div class="modal-content">
                        <form class="form-horizontal" action="<?php echo site_url('adminDownload/add'); ?>" method="post">
                            ...
                            <h4 class="modal-title">Tambah Data</h4>
                                  ...
                                  <div class="modal-body">
                                    <input name="id" type="hidden" value="">
                                      <div class="form-group">
                                          ...
                                          <div class='col-md-9'><input type="text" name="nama_file" autocomplete="off" required placeholder="Masukkan Nama File" class="form-control" ></div>
                                      </div>
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <div class="btn-group">
                                        ...
                                        <input name="Delete" type="submit" value="Hapus" class="btn btn-danger" data-hint="Klik untuk Hapus Post">
                                      </div>
                                  </div>
                        </form>
                       </div>
         ...
         <?php $no=0; foreach($all as $row): $no++; ?>
                  <div class="row">
                    <div id="modal-edit<?=$row->id;?>" class="modal fade">
                      <div class="modal-dialog">
                        <form class="form-horizontal" action="<?php echo site_url('adminDownload/edit'); ?>" method="post">
                        <div class="modal-content">
                          <div class="modal-header bg-primary">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                           ...
                           <div class="form-group">
                              <label class='col-md-3'>Nama File</label>
                              <div class='col-md-9'><input type="text" name="nama_file" value="<?=$row->nama_file;?>" autocomplete="off" required placeholder="Masukkan Nama File" class="form-control" ></div>
                            </div>
                            <div class="form-group">
                              <label class='col-md-3'>Link File</label>
