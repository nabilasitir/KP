      ...
      <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Daftar Jamaah Tour Muslim</h3>
              <h3><small>Klik untuk menambahkan/mengedit Data Customer Tour Muslim</small></h3>
            </div>
          ...
          <div class="row">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>Panel Setup Customer Tour Muslim</h2>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                    ...
                    <div class="panel panel-primary">
                          <div class="panel-heading">
                              <i class="fa fa-table"></i> Data Jamaah Tour Muslim
                          </div>
                          <!-- /.panel-heading -->
                                      ...
                                      <td>
                                        <center>
                                          <div class="tooltip-demo">
                                            ...
                                            <a href="<?php echo site_url('adminCustomerTour/hapus/'.$row->id_jamaah); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?=$row->nama;?> ?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                          </div>
                                        </center>
                                      </td>
                                    </tr>
                     ...
                     <!-- /.panel-primary -->
                          ...
                          <div id="modal-tambah" class="modal fade">
                              <div class="modal-dialog">
                                <form class="form-horizontal" action="<?php echo site_url('adminCustomerTour/add'); ?>" method="post">
                    ...
                    <?php $no=0; foreach($all as $row): $no++; ?>
                                    <div class="row">
                                      <div id="modal-edit<?=$row->id_jamaah;?>" class="modal fade">
                                        <div class="modal-dialog">
                                          <form class="form-horizontal" action="<?php echo site_url('adminCostumerTour/edit'); ?>" method="post">
                                          <div class="modal-content">
                                            <div class="modal-header bg-primary">
                                              <button type="button" class="close" data-dismiss="modal">&times;</button>
